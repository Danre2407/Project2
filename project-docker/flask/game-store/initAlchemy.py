...
with api.app_context():
    ...
    # game4 = Game(name="Hogwarts Legacy", available_quantity=34, category=category1, photo_url="https://m.media-amazon.com/images/I/811m+JsGAzL._AC_SX679_.jpg", tags=[tag1,tag5])
    ...
    #order2 = Order(games=[game3,game4], user=user2, address='Campus de Montegancedo, CAIT', status='pending')
